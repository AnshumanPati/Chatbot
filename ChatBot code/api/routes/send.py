...
def send():
    ...
    if(queryData['type'] == 'human'):
        ...
        if('df' in outputdfRules): # If df key is present in output dict of df rules then set new_df to it, else set new_df to old df. This is done so that our code doesn't fail.
